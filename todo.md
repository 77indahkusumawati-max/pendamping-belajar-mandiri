...
- [x] Cari seluruh penyebutan nama “Raka” pada antarmuka website.
- [x] Ganti sapaan personal menjadi sapaan umum yang inklusif.
- [x] Validasi build dan tampilan setelah revisi.
- [x] Simpan checkpoint revisi website.

- [x] Tambahkan login lokal berbasis browser dan sapaan sesuai nama pengguna.
- [x] Simpan nama pengguna, checklist, dan target harian melalui localStorage.
- [x] Buat halaman materi yang terhubung dari kartu dashboard.
